	...
	main(void)
{
	...
	while (col < c_end)
	{
		...
		while (row < r_end)
		{
			if ((col == 100 || col == c_end - 1)
				&& (175 <= row && row <= 324))
				mlx_pixel_put_screen(&screen, col, row, 0x0000FF00);
			else if (row == 0.5 * col - 25)
				mlx_pixel_put_screen(&screen, col, row, 0x0000FF00);
			else if (row == -0.5 * col + 225)
				mlx_pixel_put_screen(&screen, col, row, 0x0000FF00);
			else if (row == 0.5 * col + 274)
				mlx_pixel_put_screen(&screen, col, row, 0x0000FF00);
			else if (row == -0.5 * col + 524)
				mlx_pixel_put_screen(&screen, col, row, 0x0000FF00);
			row++;
		}
		col++;
